...
public class MoleHole {
	/**Les trous permettent au joueur d'avancer sous terre, ils sont
	 * crees par des Bombes Taupe ou par des joueurs qui remontent
	 * a la surface.
	 */
