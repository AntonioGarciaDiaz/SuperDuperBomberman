...
public class Player{
	/**Les personnages controles par les joueurs.
	 * Le but du joueur est de parcourir le tableau en posant des bombes
	 * (contenues dans une liste) pour faire exploser des murs et des
	 * joueurs rivaux.
	 * A difference de la plupart des objets du tableau, qui sont
	 * poses en cases de 32x32 pixels, les joueurs peuvent se deplacer
	 * librement de pixel en pixel. Neanmoins ils possedent une fonction
	 * leur permettant de trouver leur position en cases de 32x32 pixels,
	 * ce qui est utile pour placer des bombes, leur fonction principale.
	 */
	...
	public void placePlayer(int scX, int scY){
		/**Place un joueur, en fonction de son id, dans un coin
		 * du tableau de jeu.
		 */
		if(id == 1){
			posX = 0; posY = 0;
	...
	public void placeBomb(){
		/**Pose une bombe a la case occupee par le joueur.
		 * La bombe devient alors active et acquiert la portee et 
		 * l'effet specifie par les variables propres au joueur.
		 * Un chronometre est alors lance pour l'explosion.
		 */
	...
	public void intoGround(){
		/**Met le joueur sous terre et compte le temps de vie
		 * qu'il lui reste avant d'y etouffer.
		 */
	...
	public void deathTimer(){
		/**Lance la "pose de mort" du joueur.
		 */
		deathPose = 1;
	...
	public void toRemove(){
		/**Marque le joueur pour etre desactive par le modele.
		 */
